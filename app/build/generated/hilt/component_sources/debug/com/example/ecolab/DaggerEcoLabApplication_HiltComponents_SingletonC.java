...
public final class DaggerEcoLabApplication_HiltComponents_SingletonC {
  private DaggerEcoLabApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public Builder parserModule(ParserModule parserModule) {
      Preconditions.checkNotNull(parserModule);
      return this;
    }
  ...
  private static final class ActivityRetainedCBuilder implements EcoLabApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public EcoLabApplication_HiltComponents.ActivityRetainedC build() {
      return new ActivityRetainedCImpl(singletonCImpl);
    }
  }

  private static final class ActivityCBuilder implements EcoLabApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements EcoLabApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements EcoLabApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements EcoLabApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements EcoLabApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements EcoLabApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public EcoLabApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends EcoLabApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends EcoLabApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends EcoLabApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends EcoLabApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends EcoLabApplication_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityRetainedCImpl extends EcoLabApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends EcoLabApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends EcoLabApplication_HiltComponents.SingletonC {
    ...
    private Provider<GeoJsonParser> provideGeoJsonParserProvider;

    private Provider<AssetPointsRepository> assetPointsRepositoryProvider;
    ...
    private AuthRepositoryImpl authRepositoryImpl() {
      return new AuthRepositoryImpl(provideFirebaseAuthProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideGeoJsonParserProvider = DoubleCheck.provider(new SwitchingProvider<GeoJsonParser>(singletonCImpl, 2));
    ...
    @Override
    public void injectEcoLabApplication(EcoLabApplication ecoLabApplication) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 1: // com.example.ecolab.core.data.repository.AssetPointsRepository 
          return (T) new AssetPointsRepository(singletonCImpl.provideGeoJsonParserProvider.get());

          case 2: // com.example.ecolab.core.data.prepopulation.GeoJsonParser 
          return (T) ParserModule_ProvideGeoJsonParserFactory.provideGeoJsonParser(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 3: // com.example.ecolab.core.domain.repository.AuthRepository 
          return (T) AppModule_ProvideAuthRepositoryFactory.provideAuthRepository(singletonCImpl.authRepositoryImpl());
